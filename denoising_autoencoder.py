...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 19 21:35:32 2017
...
def dropout(val,layer):
    mask = np.random.binomial(1,0.9,[layer.shape[0], layer.shape[1]])
    return (mask * layer)
